...
const fetchProfile = async () => {
    ...
    // Expose a refresh function for profile updates
    ...
    // Expose a refresh function for user details (e.g., token updates)
            ...
            const response = await axios.get(
                ...
                if (chatIndex > -1) {
                    ...
                    updatedChats[chatIndex].messages = [
                        ...new Map(
                            [...updatedChats[chatIndex].messages, ...response.data.messages].map(
                                (msg) => [msg._id, msg] // Ensure messages are unique by ID
                            )
                        ).values(),
                    ];
                } else {
