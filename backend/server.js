...
app.use(express.json({
  verify: (req, res, buf) => {
    ...
    console.log('Raw Body for Signature Validation:', req.rawBody);  // Ensure raw body is captured correctly
...
app.use(
  express.urlencoded({
    ...
    verify: (req, res, buf) => {
      ...
      console.log('Raw Body Captured:', req.rawBody);  // Capture raw body for URL-encoded payloads
    },
  })
);
